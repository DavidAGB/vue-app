    ...
    <div class="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
      <h2 class="text-5xl font-extrabold tracking-tight text-gray-100">Blog</h2>
        ...
        <div v-if="posts.loading" >
           <div class="flex items-center justify-center space-x-2 mt-14 animate-pulse">

		         <svg role="status" class="w-14 h-14 mr-2    animate-spin text-gray-400 fill-indigo-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div v-else class="mt-6 grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
             ...
             <asyncPost v-for="post in posts.data" :key="post.id" :post="post" class="group relative max-w-xs p-2 rounded-md shadow-md bg-gray-900 dark:text-gray-50"/>
