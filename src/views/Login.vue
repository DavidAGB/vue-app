  ...
  <div class="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
      ...
      <form class="mt-8 space-y-6" @submit="login">
        ...
        <div  v-if="errorMsg" class="  text-white bg-red-500 rounded">
        <div class="container flex items-center justify-between px-5 py-3  ">
            <div class="flex">
                
                <p class="mx-3">{{errorMsg}}</p>
            </div>

            <button @click="errorMsg = ''" class="p-1 transition-colors duration-200 transform rounded-md hover:bg-opacity-25 hover:bg-gray-600 focus:outline-none">
